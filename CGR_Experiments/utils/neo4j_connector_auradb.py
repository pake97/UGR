...
class Neo4jConnector():
    ...
    def loadDatasetToNeo4j(self, dataset):
        if(dataset=='synthea'):
            ...
            try:
                os.system('/Users/amedeo/Downloads/neo4j-community-5.12.0/bin/cypher-shell -a a6e50c1e.databases.neo4j.io:7687 -u neo4j -p 0DyYkZuUJ04N70p8AjGZ4MshDW6QPjpB9KkI6Ghu-6g -f ./config/'+dataset+'.cypher')
            except Exception as e:
                print(e)
