...
def computeRepairs(assigned_hypervertex, constraints,SEED):
    ...
    violation_id = assigned_hypervertex['name']
    
    nodes_ids = assigned_hypervertex['properties']['nodes'].split(",")
    
    node_labels = assigned_hypervertex['properties']['labels'].split(",")
    
    violation_type = assigned_hypervertex['properties']['type']
    
    violation_vertex_id = assigned_hypervertex.index    
    ...
    return_object = {
        ...
        'violation_vertex_id':violation_vertex_id,
