...
class CGREnvironment:
    ...
    def start_fixed_arrival_simulation(self):
        ...
        for users in [5,10,15,20,25,30,40,60,80,100]:
            for assignment in ["random","degreeAsc","prAsc"]:
                print("Running synthea125 " +str(users) +" " +assignment )        
                self.wait_count=0
                self.iteration_count=0
                self.interaction_count=0
                ...
                while graphInconsistent: 
                    ...
                    if(self.iteration_count>2*len(violations_ids)):
                        ...
                        for u in self.users:
                            ...
                            elif assignment=="betweennessDesc":
                            ...
                            elif assignment=="betweennessAsc":
                                    ...
                                    while(True):
                                        if(checkSafety(chosen_repair,assigned_hypervertex,self.neo4j_Connector,self.constraints)):
                                            ...
                                            if(len(u.actions)==0):
                                                ...
                                                chosen_repair = u.select_action_by_policy(self.answer_distribution,1)
                                else:
                                    chosen_repairs.append(chosen_repair)
                                    chosen_violations.append(assigned_hypervertex)
